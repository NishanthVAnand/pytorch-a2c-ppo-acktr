...
class Policy(nn.Module):
    ...
    def act(self, inputs, rnn_hxs, masks, prev_mean=None):
        ...
        return value, action, action_log_probs, rnn_hxs, prev_mean, beta_actor
